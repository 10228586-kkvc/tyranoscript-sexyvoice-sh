...
*/
    ...
    // スマホ・タブレットのジェスチャー操作
    gesture: {
        "swipe_up_1"    : function () {$("html").trigger({type: 'keydown', keyCode: 38});},
        "swipe_down_1"  : function () {$("html").trigger({type: 'keydown', keyCode: 40});},
        "swipe_left_1"  : function () {$("html").trigger({type: 'keydown', keyCode: 37});},
        "swipe_right_1" : function () {$("html").trigger({type: 'keydown', keyCode: 39});},
/*
